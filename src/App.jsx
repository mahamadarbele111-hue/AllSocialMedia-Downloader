...
const softStyles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .wa-fab {
    ...
    box-shadow: 6px 6px 16px rgba(18,140,126,0.45), -4px -4px 10px rgba(255,255,255,0.08), 0 0 0 0 rgba(37,211,102,0.4);
    display: flex;
    align-items: center;
    justify-content: center;
    cursor: pointer;
  ...
  .wa-fab:hover {
    ...
    box-shadow: 8px 8px 20px rgba(18,140,126,0.55), -4px -4px 10px rgba(255,255,255,0.1), 0 0 0 8px rgba(37,211,102,0.15);
  }
  .wa-fab:active {
  ...
  .wa-fab-tooltip {
    ...
    background: var(--card);
    box-shadow: 4px 4px 12px var(--shadow-d), -4px -4px 12px var(--shadow-l);
    border-radius: 10px;
    padding: 6px 12px;
    font-size: 11px;
    font-weight: 800;
  ...
  @keyframes waPulse {
    0%,100% { box-shadow: 6px 6px 16px rgba(18,140,126,0.45), -4px -4px 10px rgba(255,255,255,0.08); }
    50%      { box-shadow: 6px 6px 22px rgba(18,140,126,0.6), -4px -4px 10px rgba(255,255,255,0.1), 0 0 0 6px rgba(37,211,102,0.12); }
  }
