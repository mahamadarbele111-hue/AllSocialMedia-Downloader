        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 8, marginBottom: 20, flexWrap: 'nowrap', overflowX: 'auto', padding: '0 4px' }}>
            ...
            <a
              ...
              rel="noreferrer"
              className="neu-btn"
              style={{ padding: '6px 14px', display: 'flex', alignItems: 'center', gap: 7, fontSize: 11, fontWeight: 800, color: '#25D366', borderRadius: 30, textDecoration: 'none' }}
            >
